...
class HomeScreen extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      backgroundColor: Color.fromARGB(241, 7, 152, 255),
      drawer: const Drawer(
      ),
      appBar: AppBar(
        backgroundColor: Color.fromARGB(0, 64, 77, 88),
          ...
          children: [
            ...
            Padding(
              ...
              child: Row(
                ...
                children: const [
                  Text('Popular shoes', style: TextStyle(color: Color.fromARGB(255, 255, 255, 255), fontSize: 20),),
            ...
            Row(
              children: [
                Container(
                  ...
                  decoration: BoxDecoration(
                    borderRadius: BorderRadius.circular(20),
                    color: Color.fromARGB(123, 231, 37, 37),
                  ),
                  child: Padding(
                          ...
                          // Expanded(
                            ...
                            angle: -math.pi / 4,
                              child: Padding(
                                ...
                                child: Image.asset('assets/s1.png',scale: 0.5,),
                              ),                  
                            ),
